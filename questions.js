...
export const QUESTIONS = {
  ...
  en: {
    self: [
      ...
      "In your friend group, are you usually the one who brings up the energy and plans things, or are you more of the quiet listener on the side?",
      ...
      "Which season of the year do you like most? Do you usually prefer going outside on sunny days, or enjoying the calm of staying in your room on a rainy day with a candle and a show?",
